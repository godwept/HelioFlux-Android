...
fun AceEpamSample.toEntity()=AceEpamEntity(timestampMillis,electronLow,electronHigh,protonLow,protonMid,protonHigh,protonFp6,protonP7); fun AceEpamEntity.toDomain()=AceEpamSample(timestampMillis,electronLow,electronHigh,protonLow,protonMid,protonHigh,protonFp6,protonP7)

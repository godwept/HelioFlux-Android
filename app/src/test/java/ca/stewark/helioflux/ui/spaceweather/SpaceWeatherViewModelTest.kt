...
class SpaceWeatherViewModelTest {
    private fun loadingViewModel(scope: CoroutineScope) = SpaceWeatherViewModel.forTest(
    ...
    @Test fun uiStateDefaultsToTwelveHours() {
        assertEquals(Timeframe.TwelveHours, SpaceWeatherUiState().timeframe)
    }

    @Test fun viewModelEmitsTwelveHoursBeforeSelection() = runBlocking {
